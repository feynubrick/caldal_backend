            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="스케쥴 표시에 사용되는 색의 HEX 코드",
                        max_length=7,
                        null=True,
                        validators=[
                ...
                (
                    "created_at",
                    caldal.util.fields.CreatedAtField(
                        auto_now_add=True, db_comment="생성 시간", help_text="생성 시간"
                    ),
                ),
                (
                    "owner",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        db_comment="시작 시간", db_index=True, help_text="시작 시간"
                    ),
                ),
                (
                    "end_time",
                    models.DateTimeField(
                        db_comment="종료 시간", db_index=True, help_text="종료 시간"
                    ),
                ),
